...
const homeCards = [
  {
    ...
    description: 'Check the tutorials created by members of our community.',
    ...
    <>
      <div className="row">
        <div className="col col--6">
          <div className="markdown greetings">
            ...
            <a href={customFields.sandboxUrl}>
      ...
      <div className="row home-middle">
        {homeCards.map((homecard) => {
          return (
            <div className="col col--4 sm-p-56" key={homecard.title}>
      ...
      <div className="row home-middle">
        ...
        <div className="developer-btn">
          <a href={customFields.developerUrl}>
      ...
      >
        ...
        <a href={customFields.discordUrl} className="button">
          Join Discord
        </a>
      </div>
      <div
